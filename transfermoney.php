...
<body style="background-color : #5de8b7;">
<?php
    include 'config.php';
            ...
            <div class="row">
                ...
                ?>
                    <tr style="color : black;">
                        ...
                        <td><a href="selecteduserdetail.php?id= <?php echo $rows['cid'] ;?>"> <button class="btn btn-outline-dark btn">View and Transact</button></a></td> 
                    </tr>
                <?php
                    }
                ?>
