    ...
    if (($amount)<0)
   {
    ...
    // constraint to check zero values
         ...
         echo "</script>";
                ...
                $sql = "UPDATE customers set balance=$newbalance where cid=$from";
                mysqli_query($conn,$sql);
             

                // adding amount to reciever's account
                $newbalance = $sql2['balance'] + $amount;
                $sql = "UPDATE customers set balance=$newbalance where cid=$to";
                mysqli_query($conn,$sql);
...
<body style="background-color : #66e5bf ;">
...
?>
	...
	<div class="container">
        <h2 class="text-center pt-4" style="color : black;">TRANSACTION</h2>
            <?php
                include 'config.php';
                $sid=$_GET['id'];
                $sql = "SELECT * FROM customers where cid=$sid";
    ...
    <footer class="text-center mt-5 py-2">
            <p>&copy 2021. Made by <b>SARAVANA KUMAR R</b> <br> for the Project of<br> <b>The Sparks Foundation</b></p>
    </footer>
